...
//        screenSize(640, 480);
     ...
     */
    public void dot() {
        StdDraw.setPenRadius(Math.max(penSize + 4, penSize * 2) / 512);
    ...
    public void dot(double size, String color) {
        StdDraw.setPenColor(getColor(color));
        StdDraw.setPenRadius(size / 512);
        StdDraw.line(x, y, x, y);
        StdDraw.setPenColor(penColor);
        StdDraw.setPenRadius(penSize / 512);
